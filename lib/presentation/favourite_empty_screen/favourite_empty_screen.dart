import 'bloc/favourite_empty_bloc.dart';
...
class FavouriteEmptyScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<FavouriteEmptyBloc>(
      create: (context) => FavouriteEmptyBloc(FavouriteEmptyState(
        favouriteEmptyModelObj: FavouriteEmptyModel(),
      ))
        ..add(FavouriteEmptyInitialEvent()),
      child: FavouriteEmptyScreen(),
    );
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FavouriteEmptyBloc, FavouriteEmptyState>(
