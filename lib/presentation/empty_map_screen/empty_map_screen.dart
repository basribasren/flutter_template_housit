                  ...
                  child: Column(
                    ...
                    children: [
                      CustomAppBar(
                        ...
                        title: BlocSelector<EmptyMapBloc, EmptyMapState,
                            EmptyMapModel?>(
                          selector: (state) => state.emptyMapModelObj,
                          builder: (context, emptyMapModelObj) {
                            return AppbarDropdown(
                              margin: getMargin(
                                left: 24,
                              ),
                              hintText: "msg_jakarta_indone".tr,
                              items: emptyMapModelObj?.dropdownItemList ?? [],
                              onTap: (value) {
                                context
                                    .read<Bloc>()
