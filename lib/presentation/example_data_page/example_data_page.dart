...
import 'package:basri_s_application27/widgets/app_bar/appbar_dropdown.dart';
import 'package:basri_s_application27/widgets/app_bar/appbar_iconbutton_4.dart';
import 'package:basri_s_application27/widgets/app_bar/custom_app_bar.dart';
                                    ...
                                    children: [
                                      CustomAppBar(
                                        ...
                                        title: BlocSelector<
                                            ...
                                            ExampleDataModel?>(
                                          selector: (state) =>
                                              state.exampleDataModelObj,
                                          builder:
                                              (context, exampleDataModelObj) {
                                            return AppbarDropdown(
                                              margin: getMargin(
                                                left: 24,
                                              ),
                                              hintText: "msg_jakarta_indone".tr,
                                              items: exampleDataModelObj
                                                      ?.dropdownItemList ??
                                                  [],
                                              onTap: (value) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: BlocSelector<ExampleDataBloc,
                                    ExampleDataState, ExampleDataModel?>(
                                  selector: (state) =>
                                      state.exampleDataModelObj,
                                  builder: (context, exampleDataModelObj) {
                                    return ListView.separated(
                                      ...
                                      itemCount: exampleDataModelObj
                                              ?.layout11ItemList.length ??
                                          0,
                                      itemBuilder: (context, index) {
                                        Layout11ItemModel model =
                                            exampleDataModelObj
                                                    ?.layout11ItemList[index] ??
                                                Layout11ItemModel();
