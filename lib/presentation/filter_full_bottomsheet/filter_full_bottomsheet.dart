...
import 'package:basri_s_application27/widgets/custom_search_view.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              BlocSelector<FilterFullBloc, FilterFullState,
                ...
                selector: (state) => state.formLocationController,
                builder: (context, formLocationController) {
              ...
              Padding(
                ...
                child: BlocSelector<FilterFullBloc, FilterFullState,
                    FilterFullModel?>(
                  ...
                  builder: (context, filterFullModelObj) {
                    return Wrap(
                      ...
                      children: List<Widget>.generate(
                        filterFullModelObj?.chipview2ItemList.length ?? 0,
                        (index) {
                          Chipview2ItemModel model =
                              filterFullModelObj?.chipview2ItemList[index] ??
                                  Chipview2ItemModel();
                ...
                child: BlocSelector<FilterFullBloc, FilterFullState,
                  ...
                  builder: (context, filterFullModelObj) {
                    return Wrap(
                      ...
                      children: List<Widget>.generate(
                        filterFullModelObj?.chipviewoneItemList.length ?? 0,
                        (index) {
                          ChipviewoneItemModel model =
                              filterFullModelObj?.chipviewoneItemList[index] ??
                                  ChipviewoneItemModel();
