import 'bloc/edit_success_bloc.dart';
...
class EditSuccessBottomsheet extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<EditSuccessBloc>(
      create: (context) => EditSuccessBloc(EditSuccessState(
        editSuccessModelObj: EditSuccessModel(),
      ))
        ..add(EditSuccessInitialEvent()),
      child: EditSuccessBottomsheet(),
    );
  }
